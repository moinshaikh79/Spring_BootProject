package Alumini.Management.services.impl;
...
import Alumini.Management.entitydto.AluminiDTO;
import Alumini.Management.exception.UserNotFoundException;
import Alumini.Management.repository.AluminiRepository;
import Alumini.Management.service.AluminiService;

@Service
public class AluminiServiceIpl implements AluminiService 
{
	@Autowired
